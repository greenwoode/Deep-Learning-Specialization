...
We aim to show that domain-restricted models can learn more valuable information during training, and subsequently out perform a general model at a given size. To show this we trained two models, one on an ImageNet subset, and another on a custom dataset comprised of frames from a video game. This repository is comprised of the code utlized in its [accompanying thesis]([https://library.wit.edu/home](https://digitalcollections.wit.edu/uncategorized/IO_5f403569-57a7-470d-8ae2-b9c64943a854/)). 
